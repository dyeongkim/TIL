...
- 50 00 48
    - 0101 0000 0000 0000 0100 1000
        - **0101 0aaa** : character output 문자 출력
        - aaa(000) : Immediate 모드 주소지정방식
            - 즉시 주소 지정방식으로 문자 출력(48)
- 51 00 07
    - 0101 0001 0000 0000 0000 0111
        - **0101 0aaa** : character output 문자 출력
        - aaa(001) : Direct 모드 주소지정방식
            - 주소 지정방식으로 문자 출력(07번지)
